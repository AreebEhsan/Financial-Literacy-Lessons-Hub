...
MASTERY_THRESHOLD = 3
# ✅ Hard-coded video
VIDEO_ID = "VaiqGsot5ws"
YOUTUBE_URL = f"https://www.youtube.com/watch?v={VIDEO_ID}"

# ---- Unique session keys for this lesson ----
LESSON_KEY   = "debt_lesson"
QNUM_KEY     = "debt_question_num"
CONVO_KEY    = "debt_conversation"
FINISHED_KEY = "debt_finished"
SCORE_KEY    = "debt_score"
...
def init_state():
    """Initialize all debt-page specific session variables."""
    defaults = {
        QNUM_KEY: 0,
        CONVO_KEY: [],
        FINISHED_KEY: False,
...
def main():
    ...
    st.title("🎥 Lesson 3: Debt Management")
