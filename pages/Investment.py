...
MASTERY_THRESHOLD = 3
# ✅ Hard-coded video
VIDEO_ID = "qIw-yFC-HNU"
YOUTUBE_URL = f"https://www.youtube.com/watch?v={VIDEO_ID}"

# ---- Unique session keys for this lesson ----
LESSON_KEY   = "investment_lesson"
QNUM_KEY     = "investment_question_num"
CONVO_KEY    = "investment_conversation"
FINISHED_KEY = "investment_finished"
...
def init_state():
    """Initialize all investment-page specific session variables."""
    defaults = {
        QNUM_KEY: 0,
        CONVO_KEY: [],
        FINISHED_KEY: False,
